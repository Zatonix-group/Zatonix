                    ...
                    <div class="about-content">
                        ...
                        <div class="about-lists">
                            <div class="about-list">
                                <ul>
                                    <li><i class="bi bi-check2"></i>Print Advertising</li>
                                    <li><i class="bi bi-check2"></i>Television and Radio Advertising</li>
                                </ul>
                            </div>
                            <div class="about-list">
                                <ul>
                                    <li><i class="bi bi-check2"></i>Direct Mail Marketing</li>
                                    <li><i class="bi bi-check2"></i>Outdoor Advertising</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-btn">
