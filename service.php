			...
			<div class="row align-items-center d-flex">
				...
				<div class="col-lg-6">
					...
					<div class="service-button">
						<a href="service-details.php">All services<i class="fas fa-arrow-right"></i></a>
					</div>
				</div>
			</div>
					...
					<div class="service-single-box">
						...
						<div class="service-box-content">
							...
							<div class="service-btn">
								<a href="service-details.php">Read More<i class="bi bi-arrow-right"></i></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-12">
							<div class="service-form">
								<div class="service-form-title">
									<h1>Save more and get visibility for</h1>
									<h1>your business.</h1>
								</div>
								<div class="service-form-des">
									<p>Would you like to increase sales or improve quality of your leads? Is it time to step up it 
										revenue indicators? Our SEO agency can  you reach your goals </p>
								</div>
			...
			<div class="row align-items-center d-flex">
				...
				<div class="col-lg-6">
					...
					<div class="choose-button">
						<a href="why-choose.php">All services<i class="fas fa-arrow-right"></i></a>
					</div>
				</div>
			</div>
